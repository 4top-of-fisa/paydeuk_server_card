...
INSERT INTO issued_card(user_id, card_id, card_number, cvc, expiration_year, expiration_month, card_password, created_at, updated_at)
...
(6, 2, '1111-2222-3333-4444', '123', '2026', '12', '00', NOW(), NOW());           -- 혜영
...
INSERT INTO discount_rate (benefit_id, spending_range_id, apply_type, amount, created_at, updated_at)
VALUES (1, 1, 'rate', 1.5, NOW(), NOW()),   -- 현대카드 M 기본혜택 전가맹점
       ...
       (7, 5, 'rate', 10, NOW(), NOW());    -- 신한카드 Mr.Life TIME 할인 이마트
...
VALUES (1, 1, 2, NOW(), NOW()); -- 테스트 / 현대카드 M / 일일 사용 횟수
